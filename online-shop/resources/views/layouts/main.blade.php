                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <form class="btn btn-sm btn-light">
            
                                <x-responsive-nav-link class="text-dark" :href="route('login')"
                                     >
                                    {{ __('Sign Up') }}
                            ...
                            <form class="btn btn-sm btn-light" method="POST"  action="{{ route('logout') }}">
                                @csrf
            
                                <x-responsive-nav-link class="text-dark"  :href="route('logout')"
                ...
                <div class="d-inline-flex align-items-center d-block d-lg-none">
                    <a href="" class="btn px-0 ml-2">
                        ...
                        <span class="badge text-dark border border-dark rounded-circle" style="padding-bottom: 2px">
                            {{ count(session()->get('favorite_list', [])) }}
                        </span>
                    </a>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ url('') }}"  class="nav-item nav-link {{'/'==request()->path()?'active':''}}"
                               >Home</a>

                            <a href="{{ url('shop') }}" class="nav-item nav-link {{'shop'==request()->path()?'active':''}}">Shop</a>
                            <a href="{{ url('cart') }}" class="nav-item nav-link {{'cart'==request()->path()?'active':''}}">Cart</a>
                            <a href="{{ url('checkout') }}" class="nav-item nav-link {{'checkout'==request()->path()?'active':''}}">Checkout</a>
                            <a href="{{ url('contact') }}" class="nav-item nav-link {{'contact'==request()->path()?'active':''}}">Contact</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="" class="btn px-0">
                                ...
                                id="favorite_count"   
                                style="padding-bottom: 2px">{{ count(session()->get('favorite_list', [])) }}</span>
                            </a>
