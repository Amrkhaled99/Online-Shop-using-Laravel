...
@section('content')
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            {{-- <a class="btn btn-outline-dark btn-square"      href="{{ url('/' . $product['id']). '/details' }}"> --}}
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    onclick="addProductToSession({{ $product['id'] }})" >
                                    <i class="fa fa-shopping-cart"></i></a>
                                    
                                    <a onclick="addProductToFavorite({{ $product['id'] }})"
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="{{ url('/' . $product['id']). '/details' }}">
                                    {{ $product['name'] }}
                                </a>
            ...
            @if ($product['is_recent'])
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="{{ url('/' . $product['id']). '/details' }}">{{ $product['name'] }}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>${{ $product->getPrice() }}</h5>
                                <h6 class="text-muted ml-2"><del>${{ $product['price'] }}</del></h6>
                            </div>
