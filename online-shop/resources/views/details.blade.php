                        ...
                        <form>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                @if ( $product->size==$size)
                                   @checked(true)
                                @endif 
                                class="custom-control-input" id="size-{{$size->id}}" name="size" >
                        ...
                        <form>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                @if ( $product->color==$color)
                                   @checked(true)
                                @endif 
                                class="custom-control-input" id="color-{{$color->id}}" name="color" >
                                       ...
                                       <div class="rating-css">
                                        <div class="star-icon">
                                          ...
                                          <div class="form-group">
                                            <label for="message" name="rating">Your Review *</label>
                                            <textarea id="message" cols="30" rows="5" name="review" class="form-control"></textarea>
                                        </div>
                                        <div class="form-group" name="pName" >
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                ...
                                onclick="addProductToSession({{ $p['id'] }})" >
                                <i class="fa fa-shopping-cart"></i></a>
                            
                                <a 
                                onclick="addProductToFavorite({{ $p['id'] }})"
                                class="btn btn-outline-dark btn-square" ><i
                                        class="far fa-heart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                                <a class="btn btn-outline-dark btn-square"    
                                href="{{ url('/' . $p['id']). '/details' }}"><i
